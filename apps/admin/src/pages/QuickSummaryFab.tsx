...
/**
 * Version mobile du "Résumé rapide". Sur petit écran, le bloc complet
 * prendrait trop de place affiché en dur — à la place, un bouton flottant
 * en bas de l'écran ouvre une petite fenêtre (bottom sheet) avec le même
 * contenu que QuickSummary.tsx (même liste ITEMS, réutilisée telle quelle
 * pour ne jamais désynchroniser les deux versions).
 *
 * Cachée sur desktop (md:hidden) car QuickSummary.tsx y est déjà affiché
 * inline dans le dashboard.
 */
