...
/**
 * Connexion "zéro configuration" (architecture section 4 / 11) : la
 * closeuse n'a rien à paramétrer, juste son mot de passe auto-généré par
 * l'admin. L'équipe, le rôle, les permissions sont déjà résolus côté
 * serveur via l'accessLinkId présent dans l'URL.
 */
    ...
    <div className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="text-sm text-slate-500">Espace closeuse</p>
        </div>
