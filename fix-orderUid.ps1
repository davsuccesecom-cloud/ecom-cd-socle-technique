...
Copy-Item $path "$path.backup2" -Force
Write-Host "Sauvegarde creee : $path.backup2" -ForegroundColor Green
...
Write-Host "SUCCES: receiveSheetOrder utilise maintenant orderUid pour la deduplication." -ForegroundColor Green
Write-Host "N'oublie pas d'ajouter le champ orderUid au type IncomingSheetOrder avant de deployer." -ForegroundColor Cyan
